-- SQLite Seed Data for Shop Management System with Foreign Keys

-- Insert Currencies
INSERT OR IGNORE INTO Currencies (Id, Code, Name, Symbol, IsActive, ExchangeRateToUsd, CreatedAt, UpdatedAt) VALUES
(1, 'USD', 'US Dollar', '$', 1, 1.0, datetime('now'), datetime('now')),
(2, 'EUR', 'Euro', '€', 1, 0.92, datetime('now'), datetime('now')),
(3, 'PKR', 'Pakistani Rupee', '₨', 1, 0.0036, datetime('now'), datetime('now')),
(4, 'INR', 'Indian Rupee', '₹', 1, 0.012, datetime('now'), datetime('now'));
